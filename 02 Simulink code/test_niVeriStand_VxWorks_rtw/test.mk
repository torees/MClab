# File    : test.mk (for Release 2010b and later)
#
# Abstract:
...
MODEL           		= test
MODULES         		= ni_modelframework.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c test_data.c 
MAKEFILE        		= test.mk
...
ADD_INCLUDES = \
	-I$(START_DIR)/test_niVeriStand_VxWorks_rtw \
	-I$(START_DIR) \
