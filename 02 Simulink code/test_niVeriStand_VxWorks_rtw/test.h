...
typedef struct {
  ...
  uint8_T L2_continuous_DWORK2[5];     /* '<Root>/L2_continuous' */
  uint8_T u_1_DWORK2[5];               /* '<Root>/u_1' */
  uint8_T u_2_DWORK2[5];               /* '<Root>/u_2' */
  uint8_T PosXLeft_DWORK2[5];          /* '<Root>/PosXLeft' */
  uint8_T u_3_DWORK2[5];               /* '<Root>/u_3' */
  uint8_T thr_angle_1_DWORK2[5];       /* '<Root>/thr_angle_1' */
  uint8_T u_4_DWORK2[5];               /* '<Root>/u_4' */
  uint8_T thr_angle_2_DWORK2[5];       /* '<Root>/thr_angle_2' */
  uint8_T u_5_DWORK2[5];               /* '<Root>/u_5' */
  uint8_T thr_angle_3_DWORK2[5];       /* '<Root>/thr_angle_3' */
  uint8_T u_6_DWORK2[5];               /* '<Root>/u_6' */
  uint8_T thr_angle_4_DWORK2[5];       /* '<Root>/thr_angle_4' */
  uint8_T thr_angle_5_DWORK2[5];       /* '<Root>/thr_angle_5' */
  uint8_T alpha_1_DWORK2[5];           /* '<Root>/alpha_1' */
  uint8_T thr_angle_6_DWORK2[5];       /* '<Root>/thr_angle_6' */
  uint8_T alpha_2_DWORK2[5];           /* '<Root>/alpha_2' */
  uint8_T alpha_3_DWORK2[5];           /* '<Root>/alpha_3' */
  uint8_T PosYLeft_DWORK2[5];          /* '<Root>/PosYLeft' */
  uint8_T alpha_4_DWORK2[5];           /* '<Root>/alpha_4' */
  uint8_T R2_continuous_DWORK2[5];     /* '<Root>/R2_continuous' */
  uint8_T alpha_5_DWORK2[5];           /* '<Root>/alpha_5' */
  uint8_T alpha_6_DWORK2[5];           /* '<Root>/alpha_6' */
} DW_test_T;
...
extern const real_T test_RGND;         /* real_T ground */
