# File    : ctrl_TAPM2.mk (for Release 2010b and later)
#
# Abstract:
...
MODEL           		= ctrl_TAPM2
MODULES         		= ctrl_TAPM2_data.c ni_modelframework.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c rt_zcfcn.c 
MAKEFILE        		= ctrl_TAPM2.mk
...
ADD_INCLUDES = \
	-I$(START_DIR)/ctrl_TAPM2_niVeriStand_VxWorks_rtw \
	-I$(START_DIR) \
