...
#ifndef RTW_HEADER_ctrl_TAPM2_private_h_
#define RTW_HEADER_ctrl_TAPM2_private_h_
#include "rtwtypes.h"
...
extern void ctrl_TAPM2_ActualForceandTorque(real_T rtu_n, real_T rtu_Kq, real_T
...
extern void ctrl_TAPM2_Supervisor(real_T rtu_control, real_T rtu_input, real_T
  rtu_n, B_Supervisor_ctrl_TAPM2_T *localB);
extern void ctrl_TAPM2_MATLABFunction(real_T rtu_Td, real_T rtu_K_t0, real_T
  rtu_K_t0r, real_T rtu_rho, real_T rtu_D, real_T rtu_eps_c, real_T rtu_n_r,
  B_MATLABFunction_ctrl_TAPM2_T *localB);

/* private model entry point functions */
extern void ctrl_TAPM2_derivatives(void);

#endif                                 /* RTW_HEADER_ctrl_TAPM2_private_h_ */
