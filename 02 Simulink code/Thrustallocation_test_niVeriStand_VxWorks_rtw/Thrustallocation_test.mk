# File    : Thrustallocation_test.mk (for Release 2010b and later)
#
# Abstract:
...
MODULES         		= Thrustallocation_test_data.c ni_modelframework.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c rt_zcfcn.c 
MAKEFILE        		= Thrustallocation_test.mk
...
NIVERISTAND_ROOT		:= $(subst \,/,C:\VeriStand\2015)
...
MODELLIB                  = Thrustallocation_testlib.lib
MODELREF_LINK_LIBS   	  = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/Thrustallocation_test_niVeriStand_VxWorks_rtw \
	-I$(START_DIR) \
