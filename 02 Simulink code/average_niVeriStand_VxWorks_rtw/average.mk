# File    : average.mk (for Release 2010b and later)
#
# Abstract:
...
MODEL           		= average
MODULES         		= average_data.c ni_modelframework.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE        		= average.mk
...
ADD_INCLUDES = \
	-I$(START_DIR)/average_niVeriStand_VxWorks_rtw \
	-I$(START_DIR) \
