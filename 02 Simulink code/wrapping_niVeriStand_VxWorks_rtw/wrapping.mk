# File    : wrapping.mk (for Release 2010b and later)
#
# Abstract:
...
MODEL           		= wrapping
MODULES         		= ni_modelframework.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c wrapping_data.c 
MAKEFILE        		= wrapping.mk
...
ADD_INCLUDES = \
	-I$(START_DIR)/wrapping_niVeriStand_VxWorks_rtw \
	-I$(START_DIR) \
