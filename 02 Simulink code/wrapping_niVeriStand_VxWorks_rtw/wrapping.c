...
B_wrapping_T wrapping_B;

/* Block states (auto storage) */
DW_wrapping_T wrapping_DW;

/* Real-time model */
RT_MODEL_wrapping_T wrapping_M_;
RT_MODEL_wrapping_T *const wrapping_M = &wrapping_M_;
 ...
 */
void wrapping_MATLABFunction(real_T rtu_u_pre, real_T rtu_u,
  B_MATLABFunction_wrapping_T *localB)
{
 ...
 */
void wrapping_MATLABFunction11(real_T rtu_angle_d, real_T rtu_angle,
  B_MATLABFunction11_wrapping_T *localB)
{
  real_T theta_tilde;

  /* MATLAB Function 'MATLAB Function11': '<S4>:1' */
  /* '<S4>:1:4' */
  /*  current rotation */
  /* '<S4>:1:6' */
  if (rtu_angle < 0.0) {
...
static void wrapping_output(void)
{
  real_T rtb_Gain;
  real_T rtb_Gain1;
  real_T rtb_Gain2;
  ...
  /* Gain: '<S13>/Gain1' */
  rtb_Gain1 = wrapping_P.Gain1_Gain * wrapping_B.alpha_2;

  /* Gain: '<S13>/Gain2' */
  rtb_Gain2 = wrapping_P.Gain2_Gain * wrapping_B.alpha_3;

  /* Gain: '<S13>/Gain3' */
  rtb_Gain3 = wrapping_P.Gain3_Gain * wrapping_B.alpha_4;

  /* Gain: '<S13>/Gain4' */
  rtb_Gain4 = wrapping_P.Gain4_Gain * wrapping_B.alpha_5;
   ...
   *  Memory: '<Root>/Memory5'
   */
  wrapping_MATLABFunction(wrapping_DW.Memory5_PreviousInput,
   ...
   *  Memory: '<Root>/Memory4'
   */
  wrapping_MATLABFunction(wrapping_DW.Memory4_PreviousInput,
   ...
   *  Memory: '<Root>/Memory3'
   */
  wrapping_MATLABFunction(wrapping_DW.Memory3_PreviousInput,
   ...
   *  Memory: '<Root>/Memory2'
   */
  wrapping_MATLABFunction(wrapping_DW.Memory2_PreviousInput,
   ...
   *  Memory: '<Root>/Memory'
   */
  wrapping_MATLABFunction(wrapping_DW.Memory_PreviousInput,
   ...
   *  Memory: '<Root>/Memory1'
   */
  wrapping_MATLABFunction(wrapping_DW.Memory1_PreviousInput,
    wrapping_B.sf_MATLABFunction2.angle_out, &wrapping_B.sf_MATLABFunction1);

  /* Switch: '<Root>/Switch1' */
  if (wrapping_B.nowrapping != 0.0) {
    wrapping_B.Switch1[0] = rtb_Gain;
    wrapping_B.Switch1[1] = rtb_Gain1;
    wrapping_B.Switch1[2] = rtb_Gain2;
    wrapping_B.Switch1[3] = rtb_Gain3;
    wrapping_B.Switch1[4] = rtb_Gain4;
    wrapping_B.Switch1[5] = rtb_Gain5;
  } else {
    wrapping_B.Switch1[0] = wrapping_B.sf_MATLABFunction10.y;
    wrapping_B.Switch1[1] = wrapping_B.sf_MATLABFunction8.y;
    wrapping_B.Switch1[2] = wrapping_B.sf_MATLABFunction6.y;
    wrapping_B.Switch1[3] = wrapping_B.sf_MATLABFunction3.y;
    wrapping_B.Switch1[4] = wrapping_B.sf_MATLABFunction.y;
    wrapping_B.Switch1[5] = wrapping_B.sf_MATLABFunction1.y;
  }
...
static void wrapping_update(void)
{
  /* Update for Memory: '<Root>/Memory5' */
  wrapping_DW.Memory5_PreviousInput = wrapping_B.sf_MATLABFunction10.y;

  /* Update for Memory: '<Root>/Memory4' */
  wrapping_DW.Memory4_PreviousInput = wrapping_B.sf_MATLABFunction8.y;

  /* Update for Memory: '<Root>/Memory3' */
  wrapping_DW.Memory3_PreviousInput = wrapping_B.sf_MATLABFunction6.y;

  /* Update for Memory: '<Root>/Memory2' */
  wrapping_DW.Memory2_PreviousInput = wrapping_B.sf_MATLABFunction3.y;

  /* Update for Memory: '<Root>/Memory' */
  wrapping_DW.Memory_PreviousInput = wrapping_B.sf_MATLABFunction.y;

  /* Update for Memory: '<Root>/Memory1' */
  wrapping_DW.Memory1_PreviousInput = wrapping_B.sf_MATLABFunction1.y;
   ...
   */
  if (!(++wrapping_M->Timing.clockTick0)) {
    ++wrapping_M->Timing.clockTickH0;
  }

  wrapping_M->Timing.t[0] = wrapping_M->Timing.clockTick0 *
    wrapping_M->Timing.stepSize0 + wrapping_M->Timing.clockTickH0 *
    wrapping_M->Timing.stepSize0 * 4294967296.0;
}

/* Model initialize function */
static void wrapping_initialize(void)
{
  /* InitializeConditions for Memory: '<Root>/Memory5' */
  wrapping_DW.Memory5_PreviousInput = wrapping_P.Memory5_X0;

  /* InitializeConditions for Memory: '<Root>/Memory4' */
  wrapping_DW.Memory4_PreviousInput = wrapping_P.Memory4_X0;

  /* InitializeConditions for Memory: '<Root>/Memory3' */
  wrapping_DW.Memory3_PreviousInput = wrapping_P.Memory3_X0;

  /* InitializeConditions for Memory: '<Root>/Memory2' */
  wrapping_DW.Memory2_PreviousInput = wrapping_P.Memory2_X0;

  /* InitializeConditions for Memory: '<Root>/Memory' */
  wrapping_DW.Memory_PreviousInput = wrapping_P.Memory_X0;

  /* InitializeConditions for Memory: '<Root>/Memory1' */
  wrapping_DW.Memory1_PreviousInput = wrapping_P.Memory1_X0;
}

/* Model terminate function */
static void wrapping_terminate(void)
{
...
RT_MODEL_wrapping_T *wrapping(void)
{
  /* Registration code */
  ...
  (void) memset((void *)wrapping_M, 0,
                sizeof(RT_MODEL_wrapping_T));

  /* Initialize timing info */
  {
    int_T *mdlTsMap = wrapping_M->Timing.sampleTimeTaskIDArray;
    mdlTsMap[0] = 0;
    wrapping_M->Timing.sampleTimeTaskIDPtr = (&mdlTsMap[0]);
    wrapping_M->Timing.sampleTimes = (&wrapping_M->Timing.sampleTimesArray[0]);
    wrapping_M->Timing.offsetTimes = (&wrapping_M->Timing.offsetTimesArray[0]);

    /* task periods */
    wrapping_M->Timing.sampleTimes[0] = (0.01);

    /* task offsets */
    wrapping_M->Timing.offsetTimes[0] = (0.0);
  }

  rtmSetTPtr(wrapping_M, &wrapping_M->Timing.tArray[0]);

  {
    int_T *mdlSampleHits = wrapping_M->Timing.sampleHitArray;
    mdlSampleHits[0] = 1;
    wrapping_M->Timing.sampleHits = (&mdlSampleHits[0]);
  }

  rtmSetTFinal(wrapping_M, -1);
  wrapping_M->Timing.stepSize0 = 0.01;

  /* Setup for data logging */
  {
    static RTWLogInfo rt_DataLoggingInfo;
    wrapping_M->rtwLogInfo = &rt_DataLoggingInfo;
  }

  /* Setup for data logging */
  {
    rtliSetLogXSignalInfo(wrapping_M->rtwLogInfo, (NULL));
    rtliSetLogXSignalPtrs(wrapping_M->rtwLogInfo, (NULL));
    rtliSetLogT(wrapping_M->rtwLogInfo, "tout");
    rtliSetLogX(wrapping_M->rtwLogInfo, "");
    rtliSetLogXFinal(wrapping_M->rtwLogInfo, "");
    rtliSetLogVarNameModifier(wrapping_M->rtwLogInfo, "rt_");
    rtliSetLogFormat(wrapping_M->rtwLogInfo, 0);
    rtliSetLogMaxRows(wrapping_M->rtwLogInfo, 1000);
    rtliSetLogDecimation(wrapping_M->rtwLogInfo, 1);
    rtliSetLogY(wrapping_M->rtwLogInfo, "");
    rtliSetLogYSignalInfo(wrapping_M->rtwLogInfo, (NULL));
    rtliSetLogYSignalPtrs(wrapping_M->rtwLogInfo, (NULL));
  }

  wrapping_M->solverInfoPtr = (&wrapping_M->solverInfo);
  wrapping_M->Timing.stepSize = (0.01);
  rtsiSetFixedStepSize(&wrapping_M->solverInfo, 0.01);
  rtsiSetSolverMode(&wrapping_M->solverInfo, SOLVER_MODE_SINGLETASKING);

  /* block I/O */
  wrapping_M->ModelData.blockIO = ((void *) &wrapping_B);
  (void) memset(((void *) &wrapping_B), 0,
                sizeof(B_wrapping_T));

  /* parameters */
  wrapping_M->ModelData.defaultParam = ((real_T *)&wrapping_P);

  /* states (dwork) */
  wrapping_M->ModelData.dwork = ((void *) &wrapping_DW);
  (void) memset((void *)&wrapping_DW, 0,
                sizeof(DW_wrapping_T));

  /* Initialize Sizes */
  wrapping_M->Sizes.numContStates = (0);/* Number of continuous states */
  wrapping_M->Sizes.numY = (0);        /* Number of model outputs */
...
void SetExternalInputs(double* data, int_T* TaskSampleHit)
{
  ...
  // wrapping/alpha_in/alpha_6
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&wrapping_B.alpha_6, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }

  // wrapping/alpha_in/alpha_1
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&wrapping_B.alpha_1, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }

  // wrapping/alpha_in/alpha_2
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&wrapping_B.alpha_2, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }

  // wrapping/alpha_in/alpha_3
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&wrapping_B.alpha_3, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }

  // wrapping/alpha_in/alpha_4
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&wrapping_B.alpha_4, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }

  // wrapping/alpha_in/alpha_5
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&wrapping_B.alpha_5, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }
...
void SetExternalOutputs(double* data, int_T* TaskSampleHit)
{
  ...
  // wrapping/alpha_out/alpha_3: Virtual Signal # 0
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&wrapping_B.Switch1, 2, 17, 0);
  } else {
    index += 1;
  }

  // wrapping/alpha_out/alpha_1: Virtual Signal # 0
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&wrapping_B.Switch1, 0, 17, 0);
  } else {
    index += 1;
  }

  // wrapping/alpha_out/alpha_6: Virtual Signal # 0
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&wrapping_B.Switch1, 5, 17, 0);
  } else {
    index += 1;
  }

  // wrapping/alpha_out/alpha_4: Virtual Signal # 0
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&wrapping_B.Switch1, 3, 17, 0);
  } else {
    index += 1;
  }

  // wrapping/alpha_out/alpha_5: Virtual Signal # 0
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&wrapping_B.Switch1, 4, 17, 0);
  } else {
    index += 1;
  }
...
static NI_ExternalIO NI_ExtList[] DataSection(".NIVS.extlist") =
{
  ...
  { 8, "alpha_in/alpha_1", 0, EXT_IN, 1, 1, 1 },

  { 9, "alpha_in/alpha_2", 0, EXT_IN, 1, 1, 1 },

  { 10, "alpha_in/alpha_3", 0, EXT_IN, 1, 1, 1 },

  { 11, "alpha_in/alpha_4", 0, EXT_IN, 1, 1, 1 },
...
{
  memcpy(&rtParameter[0], &wrapping_P, sizeof(P_wrapping_T));
  return NI_OK;
}

/*  After the model has initialized and updated the parameters in
   rtParameter[0] (aka wrapping_P) we make a copy to rtParameter[1] so
...
int32_t NI_InitParamDoubleBuf()
{
  ...
  for (; idx <= NUMST - TID01EQ; idx++)
    ...
    memcpy(&rtParameter[idx], &rtParameter[0], sizeof(P_wrapping_T));
  return NI_OK;
}
  ...
  value)
{
  ...
  if (ReadSideDirtyFlag == 1) {
    memcpy(&rtParameter[1-READSIDE], &rtParameter[READSIDE], sizeof(P_wrapping_T));
    ReadSideDirtyFlag = 0;
  }
  ...
  * clockTicksNames, int32_t* clockTicks)
{
  ...
  if ((discStates != NULL) && (discStatesNames != NULL)) {
    ...
    discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_1_DWORK1, 0, 0,
      0);
    strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.alpha_1_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_2_DWORK1, 0, 0,
      0);
    strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.alpha_2_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_3_DWORK1, 0, 0,
      0);
    strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.alpha_3_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_4_DWORK1, 0, 0,
      0);
    strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.alpha_4_DWORK1");
    ...
    discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.Memory4_PreviousInput,
      0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.Memory4_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.Memory3_PreviousInput,
      0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.Memory3_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.Memory2_PreviousInput,
      0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.Memory2_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.Memory_PreviousInput,
      0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.Memory_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.Memory1_PreviousInput,
      0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.Memory1_PreviousInput");
    discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_2_DWORK1_d, 0,
      0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.alpha_2_DWORK1_d");
    discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_3_DWORK1_n, 0,
      0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.alpha_3_DWORK1_n");
    discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_1_DWORK1_l, 0,
      0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.alpha_1_DWORK1_l");
    discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_6_DWORK1_b, 0,
      0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.alpha_6_DWORK1_b");
    discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_4_DWORK1_o, 0,
      0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.alpha_4_DWORK1_o");
    discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_5_DWORK1_e, 0,
      0, 0);
    ...
    for (count = 0; count < 9; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_6_DWORK2,
        count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.alpha_6_DWORK2");
    }

    for (count = 0; count < 9; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_1_DWORK2,
        count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.alpha_1_DWORK2");
    }

    for (count = 0; count < 9; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_2_DWORK2,
        count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.alpha_2_DWORK2");
    }

    for (count = 0; count < 9; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_3_DWORK2,
        count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.alpha_3_DWORK2");
    }

    for (count = 0; count < 9; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_4_DWORK2,
        count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.alpha_4_DWORK2");
    }

    for (count = 0; count < 9; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_5_DWORK2,
        count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.alpha_5_DWORK2");
    }
    ...
    for (count = 0; count < 9; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_2_DWORK2_h,
        count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.alpha_2_DWORK2_h");
    }

    for (count = 0; count < 9; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_3_DWORK2_f,
        count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.alpha_3_DWORK2_f");
    }

    for (count = 0; count < 9; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_1_DWORK2_m,
        count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.alpha_1_DWORK2_m");
    }

    for (count = 0; count < 9; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_6_DWORK2_n,
        count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.alpha_6_DWORK2_n");
    }

    for (count = 0; count < 9; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_4_DWORK2_k,
        count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.alpha_4_DWORK2_k");
    }

    for (count = 0; count < 9; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&wrapping_DW.alpha_5_DWORK2_j,
        count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100), "&wrapping_DW.alpha_5_DWORK2_j");
    }
  }
  ...
  int32_t* clockTicks)
{
  ...
  if (discStates != NULL) {
    ...
    NIRT_SetValueByDataType(&wrapping_DW.alpha_1_DWORK1, 0, discStates[idx++], 0,
      0);
    NIRT_SetValueByDataType(&wrapping_DW.alpha_2_DWORK1, 0, discStates[idx++], 0,
      0);
    NIRT_SetValueByDataType(&wrapping_DW.alpha_3_DWORK1, 0, discStates[idx++], 0,
      0);
    NIRT_SetValueByDataType(&wrapping_DW.alpha_4_DWORK1, 0, discStates[idx++], 0,
      0);
    ...
    NIRT_SetValueByDataType(&wrapping_DW.Memory5_PreviousInput, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&wrapping_DW.Memory4_PreviousInput, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&wrapping_DW.Memory3_PreviousInput, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&wrapping_DW.Memory2_PreviousInput, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&wrapping_DW.Memory_PreviousInput, 0, discStates[idx
      ++], 0, 0);
    NIRT_SetValueByDataType(&wrapping_DW.Memory1_PreviousInput, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&wrapping_DW.alpha_2_DWORK1_d, 0, discStates[idx++],
      0, 0);
    NIRT_SetValueByDataType(&wrapping_DW.alpha_3_DWORK1_n, 0, discStates[idx++],
      0, 0);
    NIRT_SetValueByDataType(&wrapping_DW.alpha_1_DWORK1_l, 0, discStates[idx++],
      0, 0);
    NIRT_SetValueByDataType(&wrapping_DW.alpha_6_DWORK1_b, 0, discStates[idx++],
      0, 0);
    NIRT_SetValueByDataType(&wrapping_DW.alpha_4_DWORK1_o, 0, discStates[idx++],
      0, 0);
    ...
    for (count = 0; count < 9; count++) {
      NIRT_SetValueByDataType(&wrapping_DW.alpha_6_DWORK2, count, discStates[idx
        ++], 18, 0);
    }

    for (count = 0; count < 9; count++) {
      NIRT_SetValueByDataType(&wrapping_DW.alpha_1_DWORK2, count, discStates[idx
        ++], 18, 0);
    }

    for (count = 0; count < 9; count++) {
      NIRT_SetValueByDataType(&wrapping_DW.alpha_2_DWORK2, count, discStates[idx
        ++], 18, 0);
    }

    for (count = 0; count < 9; count++) {
      NIRT_SetValueByDataType(&wrapping_DW.alpha_3_DWORK2, count, discStates[idx
        ++], 18, 0);
    }

    for (count = 0; count < 9; count++) {
      NIRT_SetValueByDataType(&wrapping_DW.alpha_4_DWORK2, count, discStates[idx
        ++], 18, 0);
    }

    for (count = 0; count < 9; count++) {
      NIRT_SetValueByDataType(&wrapping_DW.alpha_5_DWORK2, count, discStates[idx
        ++], 18, 0);
    }
    ...
    for (count = 0; count < 9; count++) {
      NIRT_SetValueByDataType(&wrapping_DW.alpha_2_DWORK2_h, count,
        discStates[idx++], 18, 0);
    }

    for (count = 0; count < 9; count++) {
      NIRT_SetValueByDataType(&wrapping_DW.alpha_3_DWORK2_f, count,
        discStates[idx++], 18, 0);
    }

    for (count = 0; count < 9; count++) {
      NIRT_SetValueByDataType(&wrapping_DW.alpha_1_DWORK2_m, count,
        discStates[idx++], 18, 0);
    }

    for (count = 0; count < 9; count++) {
      NIRT_SetValueByDataType(&wrapping_DW.alpha_6_DWORK2_n, count,
        discStates[idx++], 18, 0);
    }

    for (count = 0; count < 9; count++) {
      NIRT_SetValueByDataType(&wrapping_DW.alpha_4_DWORK2_k, count,
        discStates[idx++], 18, 0);
    }

    for (count = 0; count < 9; count++) {
      NIRT_SetValueByDataType(&wrapping_DW.alpha_5_DWORK2_j, count,
        discStates[idx++], 18, 0);
    }
  }
...
#endif                                 // of NI_ROOTMODEL_wrapping
