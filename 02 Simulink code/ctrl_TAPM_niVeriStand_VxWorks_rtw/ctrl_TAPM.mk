# File    : ctrl_TAPM.mk (for Release 2010b and later)
#
# Abstract:
...
MODEL           		= ctrl_TAPM
MODULES         		= ctrl_TAPM_data.c ni_modelframework.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c rt_zcfcn.c 
MAKEFILE        		= ctrl_TAPM.mk
...
ADD_INCLUDES = \
	-I$(START_DIR)/ctrl_TAPM_niVeriStand_VxWorks_rtw \
	-I$(START_DIR) \
