# File    : comp2deg.mk (for Release 2010b and later)
#
# Abstract:
...
MODEL           		= comp2deg
MODULES         		= comp2deg_data.c ni_modelframework.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE        		= comp2deg.mk
...
NIVERISTAND_ROOT		:= $(subst \,/,C:\VeriStand\2016)
...
ADD_INCLUDES = \
	-I$(START_DIR)/comp2deg_niVeriStand_VxWorks_rtw \
	-I$(START_DIR) \
