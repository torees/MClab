# File    : u2pwm_alpha.mk (for Release 2010b and later)
#
# Abstract:
...
MODEL           		= u2pwm_alpha
MODULES         		= ni_modelframework.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c u2pwm_alpha_data.c 
MAKEFILE        		= u2pwm_alpha.mk
...
MASTER_ANCHOR_DIR    	= 
START_DIR          		= C:/Users/mcl/DOCUME~1/GitHub/CS_DRI~1/02SIMU~1
S_FUNCTIONS     		= 
S_FUNCTIONS_LIB 		= 
SOLVER          		= 
NUMST           		= 1
...
ADD_INCLUDES = \
	-I$(START_DIR)/u2pwm_alpha_niVeriStand_VxWorks_rtw \
	-I$(START_DIR) \
