...
#define measurement_rtModel            RT_MODEL_measurement_T

/* Block signals (auto storage) */
typedef struct {
  real_T Noisepowerposition;           /* '<Root>/Noise power position' */
  real_T Samplingfrequency;            /* '<Root>/Sampling frequency' */
...
typedef struct {
  ...
  uint32_T RandSeed;                   /* '<S9>/White Noise' */
  uint32_T RandSeed_c;                 /* '<S10>/White Noise' */
  uint32_T RandSeed_g;                 /* '<S8>/White Noise' */
  uint8_T Noisepowerposition_DWORK2[12];/* '<Root>/Noise power position' */
  uint8_T Samplingfrequency_DWORK2[12];/* '<Root>/Sampling frequency' */
  uint8_T Noisepowerheading_DWORK2[12];/* '<Root>/Noise power heading' */
...
#define rtB                            measurement_B
#define BlockIO                        B_measurement_T
#define rtP                            measurement_P
#define Parameters                     P_measurement_T
#define rtDWork                        measurement_DW
#define D_Work                         DW_measurement_T

/* Parameters (auto storage) */
struct P_measurement_T_ {
  ...
  real_T Noisepowerposition_P6;        /* Expression: btype
                                        * Referenced by: '<Root>/Noise power position'
                                        */
  real_T Samplingfrequency_P1;         /* Expression: width
                                        * Referenced by: '<Root>/Sampling frequency'
                                        */
  real_T Samplingfrequency_P2;         /* Expression: dtype
                                        * Referenced by: '<Root>/Sampling frequency'
                                        */
  real_T Samplingfrequency_P3;         /* Expression: portnum
                                        * Referenced by: '<Root>/Sampling frequency'
                                        */
  real_T Samplingfrequency_P4;         /* Expression: stime
                                        * Referenced by: '<Root>/Sampling frequency'
                                        */
  real_T Samplingfrequency_P5;         /* Expression: stype
                                        * Referenced by: '<Root>/Sampling frequency'
                                        */
  ...
  real_T WhiteNoise_Mean_n;            /* Expression: 0
                                        ...
                                        */
  real_T WhiteNoise_StdDev_ko;         /* Computed Parameter: WhiteNoise_StdDev_ko
                                        * Referenced by: '<S8>/White Noise'
                                        */
...
extern P_measurement_T measurement_P;

/* Block signals (auto storage) */
extern B_measurement_T measurement_B;

/* Block states (auto storage) */
extern DW_measurement_T measurement_DW;

/*====================*
 * External functions *
 *====================*/
extern measurement_rtModel *measurement(void);
 ...
 *
 * '<Root>' : 'measurement'
 * '<S1>'   : 'measurement/Downsample	signal'
 * '<S2>'   : 'measurement/Sample & hold'
 * '<S3>'   : 'measurement/noise generator'
 * '<S4>'   : 'measurement/pose'
 * '<S5>'   : 'measurement/pose measured'
 * '<S6>'   : 'measurement/Downsample	signal/MATLAB Function'
 * '<S7>'   : 'measurement/Sample & hold/MATLAB Function1'
 * '<S8>'   : 'measurement/noise generator/Band-limited white noise psi'
 * '<S9>'   : 'measurement/noise generator/Band-limited white noise x'
 * '<S10>'  : 'measurement/noise generator/Band-limited white noise y'
 */
...
/* multi-rate model */
P_measurement_T rtParameter[NUMST+!TID01EQ];
P_measurement_T *param_lookup[NUMST][2] = {
...
/* multi-rate model */
extern int tid;
extern P_measurement_T* param_lookup[NUMST][2];

#else

/* single-rate model */
extern P_measurement_T rtParameter[];
