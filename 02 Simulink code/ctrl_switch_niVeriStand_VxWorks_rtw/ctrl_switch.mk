# File    : ctrl_switch.mk (for Release 2010b and later)
#
# Abstract:
...
MODEL           		= ctrl_switch
MODULES         		= ctrl_switch_data.c ni_modelframework.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE        		= ctrl_switch.mk
...
ADD_INCLUDES = \
	-I$(START_DIR)/ctrl_switch_niVeriStand_VxWorks_rtw \
	-I$(START_DIR) \
