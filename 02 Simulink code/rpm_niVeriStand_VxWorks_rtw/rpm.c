...
void rpm_output(void)
{
   ...
   */
  rpm_tmp = rpm_B.Memory3;
  revolutions_tmp = rpm_B.Memory1;
  timeold_tmp = rpm_B.Memory2;

  /* MATLAB Function 'MATLAB Function': '<S1>:1' */
  if (rpm_B.revolutions > rpm_B.Memory) {
    /* '<S1>:1:7' */
    if (rpm_B.Memory1 >= 20.0) {
      /* '<S1>:1:8' */
      /* //Update RPM every 10 counts, increase this for better RPM resolution, */
      /* //decrease for faster update */
      /* '<S1>:1:11' */
      rpm_tmp = 600.0 * rpm_B.Memory1 / (rpm_X.Integrator_CSTATE - rpm_B.Memory2);

      /* '<S1>:1:12' */
      timeold_tmp = rpm_X.Integrator_CSTATE;

      /* '<S1>:1:13' */
      revolutions_tmp = 0.0;
    } else {
      /* '<S1>:1:15' */
      revolutions_tmp = rpm_B.Memory1 + 1.0;
    }
  } else {
    if ((rpm_B.revolutions == rpm_B.Memory) && (rpm_X.Integrator_CSTATE -
         rpm_B.Memory2 > 100.0)) {
      /* '<S1>:1:17' */
      /* '<S1>:1:18' */
      rpm_tmp = 0.0;
  ...
  /* '<S1>:1:21' */
  rpm_B.timeold_out = timeold_tmp;

  /* '<S1>:1:22' */
  rpm_B.measurment_tmp = rpm_B.revolutions;

  /* '<S1>:1:23' */
  rpm_B.rpm_n = rpm_tmp;

  /* '<S1>:1:24' */
  rpm_B.revolutions_out = revolutions_tmp;
...
void rpm_update(void)
{
  if (rtmIsMajorTimeStep(rpm_M)) {
    ...
    rpm_DW.Memory3_PreviousInput = rpm_B.rpm_n;

    /* Update for Memory: '<Root>/Memory' */
    rpm_DW.Memory_PreviousInput = rpm_B.measurment_tmp;

    /* Update for Memory: '<Root>/Memory1' */
    rpm_DW.Memory1_PreviousInput = rpm_B.revolutions_out;

    /* Update for Memory: '<Root>/Memory2' */
    rpm_DW.Memory2_PreviousInput = rpm_B.timeold_out;
  }
...
RT_MODEL_rpm_T *rpm(void)
{
  ...
  /* Initialize Sizes */
  rpm_M->Sizes.numContStates = (1);    /* Number of continuous states */
  ...
  rpm_M->Sizes.numBlocks = (12);       /* Number of blocks */
  rpm_M->Sizes.numBlockIO = (9);       /* Number of block outputs */
  rpm_M->Sizes.numBlockPrms = (30);    /* Sum of parameter "widths" */
  return rpm_M;
}
...
void SetExternalInputs(double* data, int_T* TaskSampleHit)
{
  ...
  // rpm/revolutions
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&rpm_B.revolutions, 0, data[index++], 24, 0);
  } else {
    index += 1;
  }
...
void SetExternalOutputs(double* data, int_T* TaskSampleHit)
{
  ...
  // rpm/rpm: Virtual Signal # 0
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&rpm_B.rpm_n, 0, 24, 0);
  } else {
    index += 1;
  }

  // rpm/measurment: Virtual Signal # 0
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&rpm_B.measurment_tmp, 0, 24, 0);
  } else {
    index += 1;
  }

  // rpm/revolution: Virtual Signal # 0
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&rpm_B.revolutions_out, 0, 24,
      0);
  } else {
    index += 1;
  }
...
int32_t NI_InitExternalOutputs()
{
  ...
  // rpm/revolution: Virtual Signal # 0
  ni_extout[index++] = NIRT_GetValueByDataType(&rpm_B.revolutions_out, 0, 24, 0);
  UNUSED_PARAMETER(count);
  return NI_OK;
}
...
{
  { 0, "rpm/Memory3/X0", offsetof(P_rpm_T, Memory3_X0), 24, 1, 2, 0, 0 },

  { 1, "rpm/Integrator/InitialCondition", offsetof(P_rpm_T, Integrator_IC), 24,
    1, 2, 2, 0 },

  { 2, "rpm/Memory/X0", offsetof(P_rpm_T, Memory_X0), 24, 1, 2, 4, 0 },

  { 3, "rpm/Memory1/X0", offsetof(P_rpm_T, Memory1_X0), 24, 1, 2, 6, 0 },

  { 4, "rpm/Memory2/X0", offsetof(P_rpm_T, Memory2_X0), 24, 1, 2, 8, 0 },

  { 5, "rpm/Constant/Value", offsetof(P_rpm_T, Constant_Value), 24, 1, 2, 10, 0
  },
};
...
static NI_Signal NI_SigList[] DataSection(".NIVS.siglist") =
{
  ...
  { 1, "rpm/revolutions", 0, "", offsetof(B_rpm_T, revolutions) + (0*sizeof
  ...
  { 5, "rpm/MATLAB Function", 0, "", offsetof(B_rpm_T, rpm_n) + (0*sizeof(real_T)),
    BLOCKIO_SIG, 24, 1, 2, 0, 0 },

  { 6, "rpm/MATLAB Function", 1, "", offsetof(B_rpm_T, measurment_tmp) + (0*
    sizeof(real_T)), BLOCKIO_SIG, 24, 1, 2, 0, 0 },

  { 7, "rpm/MATLAB Function", 2, "", offsetof(B_rpm_T, revolutions_out) + (0*
    sizeof(real_T)), BLOCKIO_SIG, 24, 1, 2, 0, 0 },

  { 8, "rpm/MATLAB Function", 3, "", offsetof(B_rpm_T, timeold_out) + (0*sizeof
...
{
  { 1, "revolutions", 0, EXT_IN, 1, 1, 1 },

  { 1, "rpm", 0, EXT_OUT, 1, 1, 1 },

  { 2, "measurment", 0, EXT_OUT, 1, 1, 1 },

  { 3, "revolution", 0, EXT_OUT, 1, 1, 1 },
...
static const char* NI_CompiledModelName DataSection(".NIVS.compiledmodelname") =
  "rpm";
static const char* NI_CompiledModelVersion = "1.51";
static const char* NI_CompiledModelDateTime = "Tue May 10 14:30:55 2016";
  ...
  * clockTicksNames, int32_t* clockTicks)
{
  ...
  if ((discStates != NULL) && (discStatesNames != NULL)) {
    ...
    discStates[idx] = NIRT_GetValueByDataType(&rpm_DW.revolutions_DWORK1, 0, 0,
      0);
    strcpy(discStatesNames + (idx++ * 100), "&rpm_DW.revolutions_DWORK1");
    ...
    discStates[idx] = NIRT_GetValueByDataType(&rpm_DW.rpm_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&rpm_DW.rpm_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType(&rpm_DW.measurment_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&rpm_DW.measurment_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType(&rpm_DW.revolution_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&rpm_DW.revolution_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType(&rpm_DW.revolutions_DWORK2, 0, 17,
      0);
    strcpy(discStatesNames + (idx++ * 100), "&rpm_DW.revolutions_DWORK2");
    discStates[idx] = NIRT_GetValueByDataType(&rpm_DW.revolutions_DWORK2, 1, 17,
      0);
    strcpy(discStatesNames + (idx++ * 100), "&rpm_DW.revolutions_DWORK2");
    discStates[idx] = NIRT_GetValueByDataType(&rpm_DW.revolutions_DWORK2, 2, 17,
      0);
    strcpy(discStatesNames + (idx++ * 100), "&rpm_DW.revolutions_DWORK2");
    discStates[idx] = NIRT_GetValueByDataType(&rpm_DW.revolutions_DWORK2, 3, 17,
      0);
    strcpy(discStatesNames + (idx++ * 100), "&rpm_DW.revolutions_DWORK2");
    discStates[idx] = NIRT_GetValueByDataType(&rpm_DW.rpm_DWORK2, 0, 17, 0);
    strcpy(discStatesNames + (idx++ * 100), "&rpm_DW.rpm_DWORK2");
    discStates[idx] = NIRT_GetValueByDataType(&rpm_DW.rpm_DWORK2, 1, 17, 0);
    strcpy(discStatesNames + (idx++ * 100), "&rpm_DW.rpm_DWORK2");
    discStates[idx] = NIRT_GetValueByDataType(&rpm_DW.rpm_DWORK2, 2, 17, 0);
    strcpy(discStatesNames + (idx++ * 100), "&rpm_DW.rpm_DWORK2");
    discStates[idx] = NIRT_GetValueByDataType(&rpm_DW.rpm_DWORK2, 3, 17, 0);
    strcpy(discStatesNames + (idx++ * 100), "&rpm_DW.rpm_DWORK2");
    discStates[idx] = NIRT_GetValueByDataType(&rpm_DW.measurment_DWORK2, 0, 17,
      0);
    strcpy(discStatesNames + (idx++ * 100), "&rpm_DW.measurment_DWORK2");
    discStates[idx] = NIRT_GetValueByDataType(&rpm_DW.measurment_DWORK2, 1, 17,
      0);
    strcpy(discStatesNames + (idx++ * 100), "&rpm_DW.measurment_DWORK2");
    discStates[idx] = NIRT_GetValueByDataType(&rpm_DW.measurment_DWORK2, 2, 17,
      0);
    strcpy(discStatesNames + (idx++ * 100), "&rpm_DW.measurment_DWORK2");
    discStates[idx] = NIRT_GetValueByDataType(&rpm_DW.measurment_DWORK2, 3, 17,
      0);
    strcpy(discStatesNames + (idx++ * 100), "&rpm_DW.measurment_DWORK2");
    discStates[idx] = NIRT_GetValueByDataType(&rpm_DW.revolution_DWORK2, 0, 17,
      0);
    strcpy(discStatesNames + (idx++ * 100), "&rpm_DW.revolution_DWORK2");
    discStates[idx] = NIRT_GetValueByDataType(&rpm_DW.revolution_DWORK2, 1, 17,
      0);
    strcpy(discStatesNames + (idx++ * 100), "&rpm_DW.revolution_DWORK2");
    discStates[idx] = NIRT_GetValueByDataType(&rpm_DW.revolution_DWORK2, 2, 17,
      0);
    strcpy(discStatesNames + (idx++ * 100), "&rpm_DW.revolution_DWORK2");
    discStates[idx] = NIRT_GetValueByDataType(&rpm_DW.revolution_DWORK2, 3, 17,
      0);
    strcpy(discStatesNames + (idx++ * 100), "&rpm_DW.revolution_DWORK2");
  }
  ...
  int32_t* clockTicks)
{
  ...
  if (discStates != NULL) {
    ...
    NIRT_SetValueByDataType(&rpm_DW.Memory3_PreviousInput, 0, discStates[idx++],
      0, 0);
    NIRT_SetValueByDataType(&rpm_DW.revolutions_DWORK1, 0, discStates[idx++], 0,
      0);
    ...
    NIRT_SetValueByDataType(&rpm_DW.Memory2_PreviousInput, 0, discStates[idx++],
      0, 0);
    NIRT_SetValueByDataType(&rpm_DW.rpm_DWORK1, 0, discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&rpm_DW.measurment_DWORK1, 0, discStates[idx++], 0,
      0);
    NIRT_SetValueByDataType(&rpm_DW.revolution_DWORK1, 0, discStates[idx++], 0,
      0);
    NIRT_SetValueByDataType(&rpm_DW.revolutions_DWORK2, 0, discStates[idx++], 17,
      0);
    NIRT_SetValueByDataType(&rpm_DW.revolutions_DWORK2, 1, discStates[idx++], 17,
      0);
    NIRT_SetValueByDataType(&rpm_DW.revolutions_DWORK2, 2, discStates[idx++], 17,
      0);
    NIRT_SetValueByDataType(&rpm_DW.revolutions_DWORK2, 3, discStates[idx++], 17,
      0);
    NIRT_SetValueByDataType(&rpm_DW.rpm_DWORK2, 0, discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&rpm_DW.rpm_DWORK2, 1, discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&rpm_DW.rpm_DWORK2, 2, discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&rpm_DW.rpm_DWORK2, 3, discStates[idx++], 17, 0);
    NIRT_SetValueByDataType(&rpm_DW.measurment_DWORK2, 0, discStates[idx++], 17,
      0);
    NIRT_SetValueByDataType(&rpm_DW.measurment_DWORK2, 1, discStates[idx++], 17,
      0);
    NIRT_SetValueByDataType(&rpm_DW.measurment_DWORK2, 2, discStates[idx++], 17,
      0);
    NIRT_SetValueByDataType(&rpm_DW.measurment_DWORK2, 3, discStates[idx++], 17,
      0);
    NIRT_SetValueByDataType(&rpm_DW.revolution_DWORK2, 0, discStates[idx++], 17,
      0);
    NIRT_SetValueByDataType(&rpm_DW.revolution_DWORK2, 1, discStates[idx++], 17,
      0);
    NIRT_SetValueByDataType(&rpm_DW.revolution_DWORK2, 2, discStates[idx++], 17,
      0);
    NIRT_SetValueByDataType(&rpm_DW.revolution_DWORK2, 3, discStates[idx++], 17,
      0);
  }
