# File    : rpm.mk (for Release 2010b and later)
#
# Abstract:
...
MODEL           		= rpm
MODULES         		= ni_modelframework.c rpm_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE        		= rpm.mk
...
ADD_INCLUDES = \
	-I$(START_DIR)/rpm_niVeriStand_VxWorks_rtw \
	-I$(START_DIR) \
